...
public class GameBoard {
    ...
    private void initPositions() {
        ...
        boardPositions.add(new BoardPosition("Rec Center", 5, new int[] {3, 4, 5, 6}));
        ...
        boardPositions.add(new BoardPosition("South Hall", 15, new int[] {1, 3, 5, 4}));
        ...
        boardPositions.add(new BoardPosition("Lactation Lounge", 20, new int[] {20}));
